package com.comeon.android.component.home.video.ui.view;
...
import com.comeon.android.component.R;
...
public class VerticalProgressView extends View {
    ...
    private void init(Context context) {
        ...
        strokeWidth = (float) DisplayUtils.dp2px(context, DEF_PROGRESS_STOKE_WIGHT);
        ...
        defViewWidth = DisplayUtils.dp2px(context, DEF_PROGRESS_STROKE_VIEW_WEIGHT + DEF_HORIZONTAL_GAP * 2);
        defViewHeight = DisplayUtils.dp2px(context, DEF_PROGRESS_STROKE_VIEW_HEIGHT + DEF_VERTICAL_GAP * 2);


        verticalGap = DisplayUtils.dp2px(context, DEF_VERTICAL_GAP);
        horizontalGap = DisplayUtils.dp2px(context, DEF_HORIZONTAL_GAP);
        radiusDifference = DisplayUtils.dp2px(context, DEF_RADIUS_DIFFERENCE);
    }
    ...
    protected void onVisibilityChanged(@NonNull View changedView, int visibility) {
        ...
        if (visibility == View.VISIBLE) {
            ...
            Logger.INSTANCE.d(TAG, "VISIBLE");
            handler.removeCallbacks(runnable);
            handler.postDelayed(runnable,DELAY_TIME);
        }else if (visibility == View.GONE || visibility == View.INVISIBLE){
            handler.removeCallbacks(runnable);
            Logger.INSTANCE.d(TAG, "GONE OR INVISIBLE");
        }
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        circleY = progressTop;
        Logger.INSTANCE.d("onSizeChanged","progress:"+progress);
    }
